...
# ВОПРОС 1_1
    ...
    ans_1_1 = browser.find_element(By.ID, '1_1_top_3')
    ans_1_1.click()
...
# ВОПРОС 1_2
    time.sleep(0.5)
    ans_1_2 = browser.find_element(By.ID, '1_2_top_3')
    ans_1_2.click()
...
# ВОПРОС 1_3
    time.sleep(0.5)
    ans_1_3 = browser.find_element(By.ID, '1_3_top_3')
    ans_1_3.click()
...
# ВОПРОС 1_4
    time.sleep(0.5)
    ans_1_4 = browser.find_element(By.ID, '1_4_top_3')
    ans_1_4.click()
...
# ВОПРОС 1_5
    time.sleep(0.5)
    ans_1_5 = browser.find_element(By.ID, '1_5_top_3')
    ans_1_5.click()
...
# ВОПРОС 1_6
    time.sleep(0.5)
    ans_1_6 = browser.find_element(By.ID, '1_6_top_3')
    ans_1_6.click()
...
# ВОПРОС 1_7
    time.sleep(0.5)
    ans_1_7 = browser.find_element(By.ID, '1_7_top_3')
    ans_1_7.click()
...
# ВОПРОС 1_8
    time.sleep(0.5)
    ans_1_8 = browser.find_element(By.ID, '1_8_top_3')
    ans_1_8.click()
...
# ВОПРОС 1_9
    time.sleep(0.5)
    ans_1_9 = browser.find_element(By.ID, '1_9_top_3')
    ans_1_9.click()
...
# ВОПРОС 1_10
    time.sleep(0.5)
    ans_1_10 = browser.find_element(By.ID, '1_10_top_3')
    ans_1_10.click()
...
# ВОПРОС 1_11
    time.sleep(0.5)
    ans_1_11 = browser.find_element(By.ID, '1_11_top_3')
    ans_1_11.click()
...
# ВОПРОС 1_12
    time.sleep(0.5)
    ans_1_12 = browser.find_element(By.ID, '1_12_top_3')
    ans_1_12.click()
...
# ВОПРОС 1_13
    time.sleep(0.5)
    ans_1_13 = browser.find_element(By.ID, '1_13_top_3')
    ans_1_13.click()
...
# ВОПРОС 1_14
    time.sleep(0.5)
    ans_1_14 = browser.find_element(By.ID, '1_14_top_3')
    ans_1_14.click()
...
# ВОПРОС 1_15
    time.sleep(0.5)
    ans_1_15 = browser.find_element(By.ID, '1_15_top_3')
    ans_1_15.click()
