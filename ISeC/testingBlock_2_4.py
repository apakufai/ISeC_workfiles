...
try:
    browser.get('file:///C:/Users/Admin/Desktop/ISeC/test_2.html')
    btn_2_start = browser.find_element(By.ID, 'test_2_start')
    btn_2_start.click()

# ВОПРОС 2_1
    time.sleep(0.5)
    ans_2_1 = browser.find_element(By.ID, '2_1_top_3')
    ans_2_1.click()
...
# ВОПРОС 2_2
    time.sleep(0.5)
    ans_2_2 = browser.find_element(By.ID, '2_2_top_3')
    ans_2_2.click()
...
# ВОПРОС 2_3
    time.sleep(0.5)
    ans_2_3 = browser.find_element(By.ID, '2_3_top_3')
    ans_2_3.click()
...
# ВОПРОС 2_4
    time.sleep(0.5)
    ans_2_4 = browser.find_element(By.ID, '2_4_top_3')
    ans_2_4.click()
...
# ВОПРОС 2_5
    time.sleep(0.5)
    ans_2_5 = browser.find_element(By.ID, '2_5_top_3')
    ans_2_5.click()
...
# ВОПРОС 2_6
    time.sleep(0.5)
    ans_2_6 = browser.find_element(By.ID, '2_6_top_3')
    ans_2_6.click()
...
# ВОПРОС 2_7
    time.sleep(0.5)
    ans_2_7 = browser.find_element(By.ID, '2_7_top_3')
    ans_2_7.click()
...
# ВОПРОС 2_8
    time.sleep(0.5)
    ans_2_8 = browser.find_element(By.ID, '2_8_top_3')
    ans_2_8.click()
...
# ВОПРОС 2_9
    time.sleep(0.5)
    ans_2_9 = browser.find_element(By.ID, '2_9_top_3')
    ans_2_9.click()
...
# ВОПРОС 2_10
    time.sleep(0.5)
    ans_2_10 = browser.find_element(By.ID, '2_10_top_3')
    ans_2_10.click()
...
# ВОПРОС 2_11
    time.sleep(0.5)
    ans_2_11 = browser.find_element(By.ID, '2_11_top_3')
    ans_2_11.click()
...
# ВОПРОС 2_12
    time.sleep(0.5)
    ans_2_12 = browser.find_element(By.ID, '2_12_top_3')
    ans_2_12.click()
...
# ВОПРОС 2_13
    time.sleep(0.5)
    ans_2_13 = browser.find_element(By.ID, '2_13_top_3')
    ans_2_13.click()
...
# ВОПРОС 2_14
    time.sleep(0.5)
    ans_2_14 = browser.find_element(By.ID, '2_14_top_3')
    ans_2_14.click()
...
# ВОПРОС 2_15
    time.sleep(0.5)
    ans_2_15 = browser.find_element(By.ID, '2_15_top_3')
    ans_2_15.click()
...
# ВОПРОС 2_16
    time.sleep(0.5)
    ans_2_16 = browser.find_element(By.ID, '2_16_top_3')
    ans_2_16.click()
...
# ВОПРОС 2_17
    time.sleep(0.5)
    ans_2_17 = browser.find_element(By.ID, '2_17_top_3')
    ans_2_17.click()
...
# ВОПРОС 2_18
    time.sleep(0.5)
    ans_2_18 = browser.find_element(By.ID, '2_18_top_3')
    ans_2_18.click()
...
# ВОПРОС 2_19
    time.sleep(0.5)
    ans_2_19 = browser.find_element(By.ID, '2_19_top_3')
    ans_2_19.click()
...
# ВОПРОС 2_20
    time.sleep(0.5)
    ans_2_20 = browser.find_element(By.ID, '2_20_top_3')
    ans_2_20.click()
...
# ВОПРОС 2_21
    time.sleep(0.5)
    ans_2_21 = browser.find_element(By.ID, '2_21_top_3')
    ans_2_21.click()
...
# ВОПРОС 2_22
    time.sleep(0.5)
    ans_2_22 = browser.find_element(By.ID, '2_22_top_3')
    ans_2_22.click()
...
# ВОПРОС 2_23
    time.sleep(0.5)
    ans_2_23 = browser.find_element(By.ID, '2_23_top_3')
    ans_2_23.click()
...
# ВОПРОС 2_24
    time.sleep(0.5)
    ans_2_24 = browser.find_element(By.ID, '2_24_top_3')
    ans_2_24.click()
...
# ВОПРОС 2_25
    time.sleep(0.5)
    ans_2_25 = browser.find_element(By.ID, '2_25_top_3')
    ans_2_25.click()
...
# ВОПРОС 2_26
    time.sleep(0.5)
    ans_2_26 = browser.find_element(By.ID, '2_26_top_3')
    ans_2_26.click()
...
# ВОПРОС 2_27
    time.sleep(0.5)
    ans_2_27 = browser.find_element(By.ID, '2_27_top_3')
    ans_2_27.click()
...
# ВОПРОС 2_28
    time.sleep(0.5)
    ans_2_28 = browser.find_element(By.ID, '2_28_top_3')
    ans_2_28.click()
...
# ВОПРОС 2_29
    time.sleep(0.5)
    ans_2_29 = browser.find_element(By.ID, '2_29_top_3')
    ans_2_29.click()
...
# ВОПРОС 2_30
    time.sleep(0.5)
    ans_2_30 = browser.find_element(By.ID, '2_30_top_3')
    ans_2_30.click()
