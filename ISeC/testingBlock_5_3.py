...
# ВОПРОС 5_1
    ...
    desired_value_5_1_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_1_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_1_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_2
    ...
    desired_value_5_2_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_2_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_2_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_3
    ...
    desired_value_5_3_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_3_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_3_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_4
    ...
    desired_value_5_4_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_4_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_4_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_5
    ...
    desired_value_5_5_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_5_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_5_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_6
    ...
    desired_value_5_6_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_6_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_6_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_7
    ...
    desired_value_5_7_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_7_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_7_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_8
    ...
    desired_value_5_8_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_8_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_8_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_9
    ...
    desired_value_5_9_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_9_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_9_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_10
    ...
    desired_value_5_10_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_10_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_10_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_11
    ...
    desired_value_5_11_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_11_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_11_3 = 1  # Значение, которое нужно установить на ползунке 3
...
# ВОПРОС 5_12
    ...
    desired_value_5_12_1 = 2  # Значение, которое нужно установить на ползунке 1
    ...
    desired_value_5_12_2 = 3  # Значение, которое нужно установить на ползунке 2
    ...
    desired_value_5_12_3 = 1  # Значение, которое нужно установить на ползунке 3
