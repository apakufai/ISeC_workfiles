...
# ВОПРОС 4_1
    time.sleep(0.5)
    ans_4_1 = browser.find_element(By.ID, '4_1_3')
    ans_4_1.click()
...
# ВОПРОС 4_2
    time.sleep(0.5)
    ans_4_2 = browser.find_element(By.ID, '4_2_3')
    ans_4_2.click()
...
# ВОПРОС 4_3
    time.sleep(0.5)
    ans_4_3 = browser.find_element(By.ID, '4_3_3')
    ans_4_3.click()
...
# ВОПРОС 4_4
    time.sleep(0.5)
    ans_4_4 = browser.find_element(By.ID, '4_4_3')
    ans_4_4.click()
...
# ВОПРОС 4_5
    time.sleep(0.5)
    ans_4_5 = browser.find_element(By.ID, '4_5_3')
    ans_4_5.click()
...
# ВОПРОС 4_6
    time.sleep(0.5)
    ans_4_6 = browser.find_element(By.ID, '4_6_3')
    ans_4_6.click()
...
# ВОПРОС 4_7
    time.sleep(0.5)
    ans_4_7 = browser.find_element(By.ID, '4_7_3')
    ans_4_7.click()
...
# ВОПРОС 4_8
    time.sleep(0.5)
    ans_4_8 = browser.find_element(By.ID, '4_8_3')
    ans_4_8.click()
...
# ВОПРОС 4_9
    time.sleep(0.5)
    ans_4_9 = browser.find_element(By.ID, '4_9_3')
    ans_4_9.click()
...
# ВОПРОС 4_10
    time.sleep(0.5)
    ans_4_10 = browser.find_element(By.ID, '4_10_3')
    ans_4_10.click()
...
# ВОПРОС 4_11
    time.sleep(0.5)
    ans_4_11 = browser.find_element(By.ID, '4_11_3')
    ans_4_11.click()
...
# ВОПРОС 4_12
    time.sleep(0.5)
    ans_4_12 = browser.find_element(By.ID, '4_12_3')
    ans_4_12.click()
...
# ВОПРОС 4_13
    time.sleep(0.5)
    ans_4_13 = browser.find_element(By.ID, '4_13_3')
    ans_4_13.click()
...
# ВОПРОС 4_14
    time.sleep(0.5)
    ans_4_14 = browser.find_element(By.ID, '4_14_3')
    ans_4_14.click()
...
# ВОПРОС 4_15
    time.sleep(0.5)
    ans_4_15 = browser.find_element(By.ID, '4_15_3')
    ans_4_15.click()
...
# ВОПРОС 4_16
    time.sleep(0.5)
    ans_4_16 = browser.find_element(By.ID, '4_16_3')
    ans_4_16.click()
